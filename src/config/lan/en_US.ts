...
const PROFILE_DATA: Experience[] = [
  {
    ...
    endDate: 'Today',
    description: [
      'I am currently leading the complete evolution of an operational management platform, involving a mobile application, integration with a legacy backend, and architectural restructuring of the measurements and technical reports workflow.',
      'Structured the mobile architecture with React Native (Expo Router, explicit state-based authentication, and protected route control)',
      'Defined and documented request contracts between frontend and backend',
      'Mappied and standardized complex payloads (including nested lists and historical objects)',
      'Implemented creation and editing of measurements with validations and full state control (loading, error, empty, success)',
      'Implemented conditional navigation based on real authentication state',
      'Structured technical tasks and roadmap organized by screens and delivery phases',
    ],
